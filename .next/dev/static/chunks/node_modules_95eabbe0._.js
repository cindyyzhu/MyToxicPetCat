...
class y extends c {
    ...
    static async create(n) {
        ...
        if ("conversationToken" in n && n.conversationToken) o = n.conversationToken;
            ...
            try {
                var i, s, a;
                const e = (null == (i = n.overrides) || null == (i = i.client) ? void 0 : i.version) || u, t = (null == (s = n.overrides) || null == (s = s.client) ? void 0 : s.source) || "js_sdk", c = `${(r = null != (a = n.origin) ? a : "https://api.elevenlabs.io", r.replace(/^wss:\/\//, "https://"))}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e}`, l = await fetch(c);
...
class I {
    static async create({ sampleRate: e, format: t, preferHeadphonesForIosDevices: n, inputDeviceId: o, workletPaths: i, libsampleratePath: a, onError: r }) {
        ...
        try {
            ...
            o && (u.deviceId = I.getDeviceIdConstraint(o));
            ...
            if (!d) {
                const e = a || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
                await c.audioWorklet.addModule(e);
            }
            await b(c.audioWorklet, null == i ? void 0 : i.rawAudioProcessor);
            const p = s({
                voiceIsolation: !0
            }, u);
    ...
    async setInputDevice(e) {
        try {
            ...
            this.settingInput = !0;
            const t = s({}, R);
            e && (t.deviceId = I.getDeviceIdConstraint(e));
            const n = s({
                voiceIsolation: !0
...
const M = w("audioConcatProcessor", '/*\n * ulaw decoding logic taken from the wavefile library\n * https://github.com/rochars/wavefile/blob/master/lib/codecs/mulaw.js\n * USED BY @elevenlabs/client\n */\n\nconst decodeTable = [0,132,396,924,1980,4092,8316,16764];\n\nfunction decodeSample(muLawSample) {\n  let sign;\n  let exponent;\n  let mantissa;\n  let sample;\n  muLawSample = ~muLawSample;\n  sign = (muLawSample & 0x80);\n  exponent = (muLawSample >> 4) & 0x07;\n  mantissa = muLawSample & 0x0F;\n  sample = decodeTable[exponent] + (mantissa << (exponent+3));\n  if (sign !== 0) sample = -sample;\n\n  return sample;\n}\n\nclass AudioConcatProcessor extends AudioWorkletProcessor {\n  constructor() {\n    super();\n    this.buffers = []; // Initialize an empty buffer\n    this.cursor = 0;\n    this.currentBuffer = null;\n    this.wasInterrupted = false;\n    this.finished = false;\n    \n    this.port.onmessage = ({ data }) => {\n      switch (data.type) {\n        case "setFormat":\n          this.format = data.format;\n          break;\n        case "buffer":\n          this.wasInterrupted = false;\n          this.buffers.push(\n            this.format === "ulaw"\n              ? new Uint8Array(data.buffer)\n              : new Int16Array(data.buffer)\n          );\n          break;\n        case "interrupt":\n          this.wasInterrupted = true;\n          break;\n        case "clearInterrupted":\n          if (this.wasInterrupted) {\n            this.wasInterrupted = false;\n            this.buffers = [];\n            this.currentBuffer = null;\n          }\n      }\n    };\n  }\n  process(_, outputs) {\n    let finished = false;\n    const output = outputs[0][0];\n    for (let i = 0; i < output.length; i++) {\n      if (!this.currentBuffer) {\n        if (this.buffers.length === 0) {\n          finished = true;\n          break;\n        }\n        this.currentBuffer = this.buffers.shift();\n        this.cursor = 0;\n      }\n\n      let value = this.currentBuffer[this.cursor];\n      if (this.format === "ulaw") {\n        value = decodeSample(value);\n      }\n      output[i] = value / 32768;\n      this.cursor++;\n\n      if (this.cursor >= this.currentBuffer.length) {\n        this.currentBuffer = null;\n      }\n    }\n\n    if (this.finished !== finished) {\n      this.finished = finished;\n      this.port.postMessage({ type: "process", finished });\n    }\n\n    return true; // Continue processing\n  }\n}\n\nregisterProcessor("audioConcatProcessor", AudioConcatProcessor);\n');
class A {
    static async create({ sampleRate: e, format: t, outputDeviceId: n, workletPaths: o }) {
        let i = null, s = null;
        try {
            i = new AudioContext({
                sampleRate: e
            });
            const a = i.createAnalyser(), r = i.createGain();
            s = new Audio, s.src = "", s.load(), s.autoplay = !0, s.style.display = "none", document.body.appendChild(s);
            const c = i.createMediaStreamDestination();
            s.srcObject = c.stream, r.connect(a), a.connect(c), await M(i.audioWorklet, null == o ? void 0 : o.audioConcatProcessor);
            const l = new AudioWorkletNode(i, "audioConcatProcessor");
            return l.port.postMessage({
                type: "setFormat",
                format: t
            }), l.connect(r), await i.resume(), n && s.setSinkId && await s.setSinkId(n), new A(i, a, r, l, s);
        } catch (e) {
            var a, r;
            throw null != (a = s) && a.parentNode && s.parentNode.removeChild(s), null == (r = s) || r.pause(), i && "closed" !== i.state && await i.close(), e;
        }
    }
    constructor(e, t, n, o, i){
...
class D extends r {
    ...
    constructor(e, t, n, o, i){
        super(e, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.visibilityChangeHandler = null, this.onInputWorkletMessage = (e)=>{
            ...
            var e;
            "visible" === document.visibilityState && null != (e = this.wakeLock) && e.released && D.requestWakeLock().then((e)=>{
                this.wakeLock = e;
            });
...
class x {
    constructor(e){
        this.websocket = null, this.eventEmitter = new F, this.currentSampleRate = 16e3, this._audioCleanup = void 0, this.currentSampleRate = e;
    }
    setWebSocket(e) {
...
class N {
    static getWebSocketUri(e = N.DEFAULT_BASE_URI) {
        return `${e}/v1/speech-to-text/realtime`;
    }
    static buildWebSocketUri(e) {
        const t = N.getWebSocketUri(e.baseUri), n = new URLSearchParams;
    ...
    static connect(e) {
        ...
        const t = new x("microphone" in e && e.microphone ? 16e3 : e.sampleRate), n = N.buildWebSocketUri(e), o = new WebSocket(n);
        return "microphone" in e && e.microphone && o.addEventListener("open", ()=>{
            N.streamFromMicrophone(e, t);
        }), t.setWebSocket(o), t;
    }
...
function a(i = {}) {
    ...
    const Y = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(async (n = {})=>{
    ...
    }, []), G = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((n, e)=>{
        ...
        if (!B.current) throw new Error("Not connected to Scribe");
        B.current.commit();
    }, []), nn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        j([]), W("");
    }, []), en = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])(()=>B.current, []);
    ...
    return D.current = t, w.current = l, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        startSession: async (n)=>{
            ...
            try {
                ...
                if (p.current = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Conversation"].startSession(u({}, null != m1 ? m1 : {}, null != n ? n : {}, {
                    origin: b,
                    ...
                    overrides: u({}, null != (r = null == m1 ? void 0 : m1.overrides) ? r : {}, null != (o = null == n ? void 0 : n.overrides) ? o : {}, {
                        client: u({}, null != (t = null == m1 || null == (l = m1.overrides) ? void 0 : l.client) ? t : {}, null != (s = null == n || null == (h = n.overrides) ? void 0 : h.client) ? s : {}, {
                            ...
                            version: (null == n || null == (A = n.overrides) || null == (A = A.client) ? void 0 : A.version) || (null == m1 || null == (R = m1.overrides) || null == (R = R.client) ? void 0 : R.version) || "0.14.0"
                        })
                    }),
...
"[project]/node_modules/@elevenlabs/react/dist/lib.modern.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "AudioFormat",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AudioFormat"],
    "CommitStrategy",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommitStrategy"],
    "RealtimeEvents",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RealtimeEvents"],
    "getLivekitUrlForLocation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$react$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getLivekitUrlForLocation"],
    "getOriginForLocation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$react$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getOriginForLocation"],
    "parseLocation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$react$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parseLocation"],
    "postOverallFeedback",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$client$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postOverallFeedback"],
    "useConversation",
    ...
    "useScribe",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$elevenlabs$2f$react$2f$dist$2f$lib$2e$modern$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useScribe"]
]);
...
//# sourceMappingURL=node_modules_95eabbe0._.js.map